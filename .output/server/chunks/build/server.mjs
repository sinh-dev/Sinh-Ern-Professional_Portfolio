...
const _routes = [
  {
    ...
    component: () => import('./index-DEOiPZKM.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DFcmBgg0.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D52eNtSm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Dm9xnKYg.mjs'));
